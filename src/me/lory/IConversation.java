...
public interface IConversation {
	 ...
	 * will be wrapped in an appropriate {@link IMessage} and sent to the
	 * server.
	 * 
	 * @param message
	 */
	...
	/**
	 * Returns the most recent messages that have been received in this
	 * conversation since the last time getRecent() has been called, or all
	 * messages if this is the first time called. Returns an empty collection if
	...
	/**
	 * Returns true if this conversation is a status conversation. A status
	 * conversation is a conversation that is auto-created on connection to the
	 * server, and handles various non-channel related communication.F
	 * 
	 * @return
	 */
	boolean isStatus();
